      ...
      body: SafeArea(
        child: state.when(
          data: (List<WeightEntry> entries) {
            final List<WeightEntry> sorted = <WeightEntry>[...entries]
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text('${entry.weightKg.toStringAsFixed(1)} kg', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w500)),
                              const SizedBox(height: 4),
                              Text(DateFormat.yMMMd().format(entry.date), style: const TextStyle(color: Color(0xFF9E9E9E))),
                            ],
                          ),
                          Text(deltaText, style: const TextStyle(color: Color(0xFFBDBDBD), fontSize: 16)),
                        ],
                      ),
                    ),
                  );
